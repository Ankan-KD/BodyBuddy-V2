...
// User dashboard — lives at its own route, /dashboard, just like the admin
// dashboard lives at /admin/dashboard. The root URL ("/") is reserved for the
// public landing page and must never render this directly; AppShell's <Gate>
// (src/components/AppShell.tsx) is responsible for routing a signed-in user
// here and keeping a signed-out visitor away from this route entirely.
